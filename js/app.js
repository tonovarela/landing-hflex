...
import { buildMockPerfiles, buildMockVacaciones, buildMockDiasFestivos } from './mock.js';
...
async function loadData() {
    ...
    if (mockPct !== null) {
        ...
        show('dashboard');
        renderDashboard(mapApiResponse(buildMockPerfiles(Number(mockPct), dept), 'mock', buildMockVacaciones(), buildMockDiasFestivos()));
        return;
    }
